...
<table id='courseDetails' class="table">
  ...
  <tr>
    ...
    <td class='input'>
      <input type="text" name="chInput1" value="<?php if($function == 'update')echo $data['contactHour'][preg_replace('/\s/', '', $data['displayCH'][0])] ?>" placeholder="hours"></td>
    <td class='label'>
      <?php $form->displaySelectCHoption(2, strtolower(preg_replace('/\s/', '', $data['displayCH'][1]))); ?></td>
    <td class='input'>
      <input type="text" name="chInput2" value="<?php if($function == 'update')echo $data['contactHour'][preg_replace('/\s/', '', $data['displayCH'][1])] ?>" placeholder="hours"></td>
    <td class='label'>
      <?php $form->displaySelectCHoption(3, strtolower(preg_replace('/\s/', '', $data['displayCH'][2]))); ?></td>
    <td class='input'>
      <input type="text" name="chInput3" value="<?php if($function == 'update')echo $data['contactHour'][preg_replace('/\s/', '', $data['displayCH'][2])] ?>" placeholder="hours"></td></tr>
  <tr>
